...
<div class="main-content">
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
            <a class="navbar-brand" href="Ingreso.aspx"><img src="img/logo.png" width="160"></a>
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item"><a class="nav-link" href="Ingreso.aspx">Inicio</a></li>
                    <li class="nav-item"><a class="nav-link" href="contactenos.aspx">Contactenos</a></li>
                </ul>
            </div> 
            <div class="Arriba">
                <a href="InicioSesion.aspx" class="navbar-brand">
                    <div class="Usuario">
                        <div class="Usu"><span class="mr-2" style="font-weight: bold;">Iniciar Sesion</span></div>
    ...
    <section class="approval-form border rounded-lg shadow p-4 position-relative">
        ...
        <div class="row" id="row">
            <div class="left">
                <img src="img/compu.png" alt="" width="600px">
            </div>
            <div class="right">
                <br><br>
